...
public class GameLobby : MonoBehaviour
{
    ...
    private async Task<Allocation> AllocateRelay()
    {
        try
        {
            Allocation allocation = await RelayService.Instance.CreateAllocationAsync(maxLobbySize);
    ...
    public async void CreateLobby(string lobbyName, bool isPrivate)
    {
        ...
        try
        {
            joinedLobby = await LobbyService.Instance.CreateLobbyAsync(lobbyName, maxLobbySize, new CreateLobbyOptions
            {
                IsPrivate = isPrivate,
            });
